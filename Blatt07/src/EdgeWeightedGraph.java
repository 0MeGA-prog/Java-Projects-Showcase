...
public class EdgeWeightedGraph {
    ...
    public static void main(String[] args) {
        // TODO
        In in = new In("graph_small.txt");  // oder eine eigene kleine Datei
        EdgeWeightedGraph G = new EdgeWeightedGraph(in);

        System.out.println("Anzahl Knoten: " + G.V());
        System.out.println("Anzahl Kanten: " + G.E());
        ...
        System.out.println("\nKoordinaten:");
        double[][] coords = G.getCoordinates();
